...
namespace Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewPostResponse"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Cloudflare.Net.Zones.Generated.Models.ApiShield_selector body, Action<RequestConfiguration<global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewRequestBuilder.PreviewRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Cloudflare.Net.Zones.Generated.Models.ApiShield_selector body, Action<RequestConfiguration<global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewRequestBuilder.PreviewRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PreviewRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Preview operations covered by a Token Validation rule.The API will return all operations on a zone annotated with an additional `state` field.Operations with an `included` `state` will be covered by a Token Validation Rule.
        /// </summary>
...
#nullable enable
            ...
            public global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PostMethodQueryParameterType[]? Method { get; set; }
#nullable restore
#else
            [QueryParameter("method")]
            public global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PostMethodQueryParameterType[] Method { get; set; }
...
#nullable enable
            ...
            public global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PostStateQueryParameterType[]? State { get; set; }
#nullable restore
#else
            [QueryParameter("state")]
            public global::Cloudflare.Net.Zones.Generated.Zones.Item.Token_validation.Rules.Preview.PostStateQueryParameterType[] State { get; set; }
